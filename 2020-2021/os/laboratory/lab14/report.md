...
![Каталог /usr/share/man/man1](image/5.png){ #fig:005 width=70% }

![Cодержимое каталога](image/6.png){ #fig:006 width=70% }

Для данной задачи я создал файл lab131.sh и написала соответствующий скрипт. (рис. -@fig:007) 

![Второй скрипт](image/7.png){ #fig:007 width=70% }

Далее я проверил работу написанного скрипта (команды «./lab131.sh ls», «./lab131.sh mkdir» и т. д.),  предварительно  добавив  право  на  исполнение  файла (команда «chmod +x lab131.sh»). Cкрипт сработал и вывел, что по данным командам справок нет. (рис. -@fig:008)
...
Для данной задачи я создал файл randomlab13.sh и написал соответствующий скрипт. (рис. -@fig:009)

![Третий скрипт](image/9.png){ #fig:009 width=70% }

Далее я проверил работу написанного скрипта (команды «./randomlab13.sh 7», «./randomlab13.sh 11»), предварительно  добавив  право  на  исполнение  файла (команда «chmod +x randomlab13.sh»). Скрипт работает корректно.(рис. -@fig:010) 
