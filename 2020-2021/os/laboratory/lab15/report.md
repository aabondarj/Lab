...
![Скрипт client.c](image/5.png){ #fig:006 width=60% }

![Скрипт client.c продолжение](image/6.png){ #fig:007 width=60% }

Makefile (файл для сборки) не изменял.

![Скрипт Makefile](image/7.png){ #fig:008 width=60% }

3) После написания кодов я, используя команду «make all», скомпилировал необходимые файлы. 

Далее я проверил работу написанного кода. Отрыла 3 консоли (терминала) и запустил:  в первом терминале − «./server», в остальных двух – «./client». 
...
![Консоли](image/8.png){ #fig:010 width=60% }
...
![Команда «./server»](image/9.png){ #fig:011 width=70% }
